...
const T = {
  ru: {
    ...
    'team.d.bio':     'Реальное портфолио: сайты и визуальные проекты. Воплощает любые дизайн-решения - от фирменного стиля до полноценного сайта. Работает с ИИ-инструментами - быстрее и нестандартнее большинства опытных дизайнеров.',
    'team.a.name':    'Арина',
