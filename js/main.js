...
const T = {
  ru: {
    ...
    'team.t.caption': 'Маркетолог, автор продукта',
    'team.i.name':    'Игорь',
    ...
    'team.a.caption': 'Архитектор клиентского пути',
  ...
  en: {
    ...
    'team.t.caption': 'Marketer, product author',
    'team.i.name':    'Igor',
    'team.i.role':    'CTO. Has been coding since age 12.',
    'team.i.caption': 'Technical Director',
    'team.d.name':    'Dima',
    'team.d.role':    'Designer and developer. 17 years old. Sites and visuals.',
    'team.d.caption': 'Designer and developer',
    'team.a.name':    'Arina',
    'team.a.role':    'Customer journey architect. Scripts bot scenarios.',
    'team.a.caption': 'Customer journey architect',
