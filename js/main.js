...
const T = {
  ru: {
    ...
    'team.t.bio':     'Более 25 лет в маркетинге. Реальный опыт в десятках бизнесов: автомагазины, общепит, культурно-развлекательный центр, интернет-магазин и розничная сеть медтехники, дистрибьюция в аптеки, стоматология, обучение фармацевтов и врачей, детские комиссионные магазины, производство, детский образовательный центр. Розница, услуги, опт, b2b, b2g - практически все форматы. 10 лет параллельно преподавала маркетинг в вузе. Автор идеи продукта: создала его потому, что на собственном опыте понимает, где бизнес теряет клиентов и деньги.',
    'team.i.name':    'Игорь',
    'team.i.role':    'Технический директор. Программирует с 12 лет',
    'team.i.bio':     'Программирует с 12 лет - за плечами уже 8 лет реальной практики. В 20 лет руководит командой разработчиков и воплощает в жизнь самые нестандартные технические задумки. В портфеле - разветвлённые CRM-системы и многофункциональные мобильные приложения. Отвечает за то, чтобы бот работал стабильно, гибко и масштабировался под любую платформу.',
    'team.d.name':    'Дима',
    'team.d.role':    'Дизайнер и разработчик. Сайты и визуал. 17 лет',
    'team.d.bio':     '17 лет - и уже реальное портфолио: сайты и визуальные проекты. Воплощает любые дизайн-решения - от фирменного стиля до полноценного сайта. Виртуозно работает с ИИ-инструментами, что позволяет делать это быстрее и нестандартнее, чем большинство опытных дизайнеров.',
    'team.a.name':    'Арина',
    'team.a.role':    'Архитектор клиентского пути. Прописывает сценарии бота',
    'team.a.bio':     '20 лет - и очень внимательный взгляд на детали. Работает за кулисами: тщательно прописывает каждый шаг, который проходит клиент на пути к покупке, чтобы бот точно понимал контекст и знал, что ответить в нужный момент. Именно благодаря её работе боты получаются с выстроенными сценариями, которые ведут клиента к результату.',
